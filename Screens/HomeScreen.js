...
            <View style={{ flex: 1, justifyContent: 'left', alignItems: 'left',marginTop:-25}}>
              <Text>{student.roll_no}. {student.name}</Text>
              <TouchableOpacity style = {[styles.button, {alignSelf:'center', width:150,marginTop:5, borderWidth:0.5},{backgroundColor:(this.state.indexPresent===index || student.Attendance === 'Present') ? 'green':'white'}]}
              onPress={()=>this.presentPressed(index+1)}>
