...
export default class ScreenSummeries extends React.Component {
  ...
  render(){
    ...
    return(
      <View style={{ flex: 1 }}>
        <AppHeader/>
      <View style={{marginTop:10,fontSize:50}}>
        <Text>Present: {noOfPresentStudents}</Text>
        <Text>Absent: {noOfAbsentStudents}</Text>
      <TouchableOpacity style = {[styles.button, {alignSelf:'center', width:500,marginTop:40,backgroundColor:'yellow', borderWidth:1}]}
